sap.ui.define([
  ...
  return Controller.extend('mlauffer.demo.openui5.tour.controller.App', {
    ...
    onInit: function() {
      ...
      this._tour = new Tour({
        steps: tourSteps,
        started: function() { MessageToast.show(resourceBundle.getText('started')); },
        completed: function(){ MessageToast.show(resourceBundle.getText('completed')); },
        nextStep: function(){ MessageToast.show(resourceBundle.getText('nextStep')); },
        previousStep: function(){ MessageToast.show(resourceBundle.getText('previousStep')); }
      });
    },
