sap.ui.define([
  ...
  var TourStep = Control.extend('openui5.tour.TourStep', {
    metadata: {
  ...
  TourStep.prototype._getPopup = function() {
    ...
    var popup = this._createPopup(this.getId(), this.getPlacement(), this.getTitle(), this.getIcon(), this.getContent());
  ...
  TourStep.prototype._setFinishButton = function (popup) {
    var button = this._createFinishButton(popup.getId(), this._finishStep.bind(this));
    popup.setEndButton(button);
    button.setType(ButtonType.Emphasized);
  };

  TourStep.prototype._setNextButton = function (popup) {
    var button = this._createNextButton(popup.getId(), this._nextStep.bind(this));
    popup.setEndButton(button);
    button.setType(ButtonType.Emphasized);
  };

  TourStep.prototype._setPreviousButton = function (popup) {
    var button = this._createPreviousButton(popup.getId(), this._previousStep.bind(this));
